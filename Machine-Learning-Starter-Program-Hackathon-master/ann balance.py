# -*- coding: utf-8 -*-
"""
Created on Mon Apr  6 17:24:50 2020
...
classifier.add(Dense(units = 400, kernel_initializer = 'he_uniform', activation = 'relu', input_dim = 12))
classifier.add(Dropout(0.4))
# Adding the second hidden layer
classifier.add(Dense(units = 400, kernel_initializer = 'he_uniform', activation = 'relu'))
classifier.add(Dropout(0.4))
classifier.add(Dense(units = 300, kernel_initializer = 'he_uniform', activation = 'relu'))
classifier.add(Dropout(0.4))
classifier.add(Dense(units = 300, kernel_initializer = 'he_uniform', activation = 'relu'))
classifier.add(Dropout(0.4))
classifier.add(Dense(units = 200, kernel_initializer = 'he_uniform', activation = 'relu'))
classifier.add(Dropout(0.4))
# Adding the second hidden layer
classifier.add(Dense(units = 200, kernel_initializer = 'he_uniform', activation = 'relu'))
classifier.add(Dropout( 0.4))
...
# In[35]:
classifier.fit(datax, y, batch_size = 64, epochs = 50)
...
submission.to_csv("ann 10 layer 400 adam e=50 balance.csv",index=False)